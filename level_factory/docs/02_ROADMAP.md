...
- LF02 Constraint-based candidate generation — MUST consume the Canonical
  Visual Contract: emit only C01..C15 logical colors on flat solid square
...
- LF05 Validation/QA — MUST enforce the Canonical Visual Contract as hard
  legality: reject off-palette/C16 colors, reject BG01 used as a logical
...
- C01..C15 logical colors only (root `data/palettes/scrubbots_palette_v1.json`;
...
- BG01 `#202533` is the fixed background — not C16, not a logical color, never
